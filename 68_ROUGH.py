...
# s = "1000_words.txt"
# k = "01_lling.log"
# if re.compile(r'^(\d{1})').match(k) and '0':
#     match = (re.compile(r'^(\d{2})').match(k))
#     if match:
#         print(True, int(match.group(1)))

# import os
# print("1000words" in os.path.splitext(s))

from cap import uservalidation
if uservalidation.valid_user('alok', 'python343'):
    print("Valid")